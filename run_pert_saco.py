...
def aggrage_info(batch_idx=0,  original_image= None, mapper = None, epsilon_rule = None, gamma_rule=None, default_op=None, num_steps = 10):
...
if __name__ == "__main__":
  ...
  for batch_idx, (data, target) in enumerate(tqdm(sample_loader)):
    ...
    aggrage_info(batch_idx=batch_idx,original_image= data.squeeze(0), 
                 mapper=mapper,epsilon_rule=epsilon_rule,
                 gamma_rule=gamma_rule,default_op=default_op, num_steps = args.num_steps)
